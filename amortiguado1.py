...
def thetaF(t): # Ángulo en función del tiempo
  #thetaFV = (theta0 * math.sin(math.sqrt(9.8/(length/1000)) * t + theta0))
  thetaFV = theta0 * math.pow(math.e, ((-b/(2*m)))*t) * math.cos((math.sqrt(math.pow(9.8/(length/180), 2)-math.pow(b/(2*m), 2))) * t + theta0)
...
while not out:
  ...
  info("Length (m): " + "?", (25,55)) # + str(round(length/1000, 2)), (25,55))
